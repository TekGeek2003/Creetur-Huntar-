...
class MonsterIndex:
    ...
    def display_main(self, dt):
        ...
        draw_bar(
            ...
            rect = pygame.FRect(level_rect.bottomleft, (120, 8)),
            value = getattr(monster, 'xp', 0),
            max_value = getattr(monster, 'level_up', 1),
            color = COLORS['white'],
            bg_color = COLORS['dark'])
        # use the Monster instance to draw its XP bar in the main pane
        lx, ly = level_rect.bottomleft
        ...
        # info
        sides = {'left': healthbar_rect.left, 'right': energybar_rect.right}
        ...
        # abilities
        ability_rect = stats_rect.copy().move_to(left = sides['right'] - 240)
